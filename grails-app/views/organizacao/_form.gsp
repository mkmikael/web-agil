...
<div class="fieldcontain">
	...
	<g:textField name="participante.nomeFantasia" value="${participanteInstance?.nomeFantasia}" size="50" />
</div>
<div class="fieldcontain">
	<label for="participante.razaoSocial">Razão Social</label>
	<g:textField name="participante.razaoSocial" value="${participanteInstance?.razaoSocial}" size="50" />
</div>
<div class="fieldcontain">
	<label for="participante.cnpj">CNPJ</label>
	<g:textField name="participante.cnpj" value="${participanteInstance?.cnpj}" />
</div>
<div class="fieldcontain">
